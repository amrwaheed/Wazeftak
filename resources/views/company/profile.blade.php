    ...
    <div class="container">
        <section class="profile-cv py-5">
            <div class="container py-5">
                <a href="{{route('company.index')}}" style="font-size: 20px;" data-toggle="tooltip" data-placement="bottom" title="Back">
                    <i class="icofont-hand-drawn-left"></i> Back
                </a>
                <div class="employee">
                    <div class="row mt-3">
                        ...
                        <div class="col-md-5">
                            <div class="caption ml-4">
                                ...
                                <a href="change-password.php" class="change-pass">Change your Password</a>
                            </div>
                        </div>
