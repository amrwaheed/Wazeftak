                ...
                <nav>
                    <ul class="metismenu" id="menu">
                        <li class="active">
                            ...
                            <ul class="collapse">
                                <li class="@yield('dashborad')"><a href="{{route('dashborad.index')}}">Dashborad Information</a></li>
                                 {{-- <li class="@yield('join')"><a href="{{route('join.index')}}">Join Information</a></li> --}}
                               {{-- <!-- <li class="@yield('users')"><a href="{{route('data')}}">Users Information</a></li> --> --}}
                                 <li class="@yield('users')"><a href="{{route('ajaxcrud.index')}}">Users Information</a></li>
