                    ...
                    <!-- Modal -->
                        <div class="modal-body">
                            ...
                            <div class="col-md-12 my-3">
                                ...
                                <textarea name="leaving" class="form-control" id="" cols="10" rows="5" placeholder="Reason for leaving" maxlength="500"></textarea><span class="text-danger">Max length is 500 characters </span>

                            </div>
                            <div class="col-md-12 my-3">

                                <input type="submit" name="submitaddexperience" id="" class="btn btn-info mr-3 px-3">
