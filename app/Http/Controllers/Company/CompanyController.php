...
class CompanyController extends Controller
{
    ...
    public function index()
    {
        ...
        $personals = DB::table('personal_informaions')
            ...
            ->join('employementinformations' , 'personal_informaions.user_id' , 'employementinformations.user_id')
...
//dd($personals);
        ...
        return view('company/companies' ,compact('personals','users' ));
    }
    ...
    public function show($id)
    {
        ...
        return view('/company/profile' ,compact('personals' , 'employement' ,'universities' , 'skills' ,
